...
Для всех работ нужно создавать отдельную ветку или делать fork. Все файлы должны находиться в папке <Номер группы>\_<фамилия> (транслит) Для лаб. работ название пулл-реквеста должно иметь следующий вид <Номер группы>\_<фамилия>\_lab<Номер работы>. В пулл-реквесте должны быть отчет в формате pdf (положить в папку report) и файл необходимые для сдачи (смотри описани лаб. работ).
