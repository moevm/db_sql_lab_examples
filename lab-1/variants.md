...
Клиент сдает в ремонт не обязательно автомобиль, владельцем которого он
...
образования и страну, состав исполнителей, положение в последнем хитпараде; репертуар группы. Сведения о каждой песне из репертуара группы -
...
Пусть требуется создать программную систему, предназначенную для
продавца журнаолов/комиксов. Такая система должна обеспечивать хранение
...
- Кто из покупетелей купил журнал более месяца тому назад?
...
- Сколько работников ищут работу с высшем образованием?
- Сколько работников имело более 3х мест работы?
- Какие вакансии имееют ЗП более 100 000р и не требуют опыта работы?
